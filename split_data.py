...
def write_paths_to_file(paths, file_name):
    dir_path = os.path.basename(file_name)
...
def split_data(opt, ignore_dirs):
  ...
  write_paths_to_file(train_paths, os.path.join(opt.save_directory,'data_list','train.txt'))
  write_paths_to_file(test_paths, os.path.join(opt.save_directory, 'data_list','test.txt'))
  write_paths_to_file(val_paths, os.path.join(opt.save_directory, 'data_list','validation.txt'))
